...
bc. HTTPS_PROXY=http://user:password@proxy.firma.de:port
HTTP_PROXY=http://user:password@proxy.firma.de:port

I got the following error message:

bc. error: error setting certificate verify locations:
...
More about 'Working with Remotes' can be found at "Pro Git":http://progit.org/book/ch2-5.html
